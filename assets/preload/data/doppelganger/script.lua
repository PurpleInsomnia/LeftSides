...
function onEndSong()
	...
	textFile("come to freeplay if u think that ur fester than meee!!!11!!\n \n -Nuckle", "fest");
	return Function_Continue;
end
...
function onNextDialogue(count)
	if count == 7 and not isAfter then
		...
		-- setPropertyFromClass("DialogueManager", "font", "funkin.otf");
	end
	...
	if count == 4 and isAfter then
		...
		-- setPropertyFromClass("DialogueManager", "font", "eras.ttf");
	end
