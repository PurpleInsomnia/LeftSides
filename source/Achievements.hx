...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Hidden achievement
		["Freaky on a Friday Night",	"Play on a Friday... Night.",							 false],
		...
		["Kromer, Reaquired",					"Beat Week 6 on Hard with no Misses.",					false],
		["Nevadas Most Wanted",		"Beat Week 7 on Hard with no Misses.",					false],
		["Heh, Pretty Good!",		"Beat Week 8 on Hard with no Misses.",					false],
		...
		["Debugger",					"Beat the \"Test\" Stage from the Chart Editor.",		 false],
		["Who Is He?",					"Encounter and Defeat The Shadow during Week 2",		 false],
		["Eighteen Naked Cowboys",					"Complete Thorns during Week 6",		 false],
	];
