...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Left Sides Team'],
		['PurpleInsomnia',		'purpleinsomnia',		'Programer, Animator, Composer, Writer and Owner of FNF Leftsides',					'https://www.youtube.com/channel/UCw1Q7T9zmJ5D3hMyhFh3lgA',	0xFFA130D0],
		[''],
		['Special Thanks'],
