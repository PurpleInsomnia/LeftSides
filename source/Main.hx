...
class Main extends Sprite
{
	...
	var initialState:Class<FlxState> = TitleScreenState; // The FlxState the game starts with. (LMFAO TITLESTATE IS BEING REPLACED)
	...
	public function new()
	{
		...
		var coolTray:LeftSidesTray;
		FlxGame._customSoundTray = LeftSidesTray;
	}
