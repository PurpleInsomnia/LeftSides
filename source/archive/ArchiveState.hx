            ...
            if (controls.ACCEPT)
            {
                switch (curTab)
                {
                    ...
                    case 7:
                        ...
                        if (toOpen.endsWith(".mp4"))
                        {
                            switch (toOpen)
                            {
                                case "CSV.mp4":
                                    CoolUtil.browserLoad("https://www.youtube.com/watch?v=BC4ee9M-EH8");
                            }
                        }
                }
            }
