...
**/
class FlxShaderToy extends GraphicsShader
{
	/**
		copied from FlxGraphicsShader
	**/
	var glVertexSourceST:String = "
		#pragma header
	...
	**/
	var glFragmentSourceST:String = "
		#pragma header
	";
	public function new(shaderToyFragment:String = "")
	{
		this.glVertexSource = glVertexSourceST;
		this.glFragmentSource = glFragmentSourceST;
		...
		data.iResolution.value = [FlxG.camera.width, FlxG.camera.height, 0.0];
		data.iTime.value = [0.0];
		data.iTimeDelta.value = [0.0];
		data.iFrame.value = [0.0];
		data.mousePosition = FlxPoint.get();
